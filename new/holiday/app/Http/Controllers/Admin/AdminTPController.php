...
$usersdatethird = substr($usersdatethirds, 0, 10);
    ...
    public function addmytriplocation(Request $request)
    {
        ...
        Log::info('ye h store function addmytriplocation ka');
        Log::info ($request);
               $input = $request->all();
